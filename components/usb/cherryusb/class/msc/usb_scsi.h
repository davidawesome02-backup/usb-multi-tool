...
#define SCSI_CMD_READ_TOC                        0x43 //basel
#define SCSI_CMD_READ_HEADER                     0x44 //basel
#define SCSI_CMD_GET_CONFIGURATION               0x46 // dvd
#define SCSI_CMD_LOGSELECT                       0x4c
#define SCSI_CMD_LOGSENSE                        0x4d
#define SCSI_CMD_XDWRITE10                       0x50
#define SCSI_CMD_READ_DISC_INFORMATION           0x51 //dvd
